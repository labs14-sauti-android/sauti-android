...
import kotlinx.android.synthetic.main.required_document_element_layout.view.*
...
class DocumentsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.required_document_element_layout, parent, false))
    }

    class ViewHolder(view : View) : RecyclerView.ViewHolder(view) {

        private val docName : TextView = view.rv_tv_document_name
