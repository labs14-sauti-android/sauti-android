...
import com.labs.sauti.converter.StringMutableListConverter
...
const val DATABASE_SCHEMA_VERSION = 29
...
@Database(
    entities = [
        ...
        FavoriteExchangeRateConversionData::class],
...
@TypeConverters(
    ...
    StringMutableListConverter::class)
abstract class SautiRoomDatabase : RoomDatabase() {
    ...
    abstract fun favoriteExchangeRateConversionDao(): FavoriteExchangeRateConversionDao
